...
def test_wei_variant() -> None:
    ...
    assert Wei(578960446186580977117854925043439539266)() == 578960446186580977117854925043439539266
    assert Wei(578960446186580977117854925043439539267)() == (
        "str",
        "578960446186580977117854925043439539267",
    )
    assert Wei(-578960446186580977117854925043439539267)() == -578960446186580977117854925043439539267
